        ...
        stage('checkout') {
         ...
         stage('build') {
            steps {
                ...
                step([$class: 'XrayImportBuilder', endpointName: '', importFilePath: 'target/surefire-reports/TEST-runcukes.RunCukesTest.xml', importInParallel: 'false', serverInstance: 'SERVER-451b35e9-535d-4f52-bc37-28f4215cf1ea'])
