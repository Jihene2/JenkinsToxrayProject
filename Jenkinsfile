        ...
        stage('checkout') {
         ...
         stage('build') {
            steps {
                ...
                bat'mvn test'
                step([$class: 'XrayImportBuilder', endpointName: '/junit', importFilePath: 'JenkinsToxrayProject/target/surefire-reports/*.xml', importInParallel: 'false', importToSameExecution: 'false', projectKey: 'TALAC', serverInstance: 'SERVER-451b35e9-535d-4f52-bc37-28f4215cf1ea', testExecKey: 'TALAC-814'])
