        ...
        stage('checkout') {
         ...
         stage('build') {
            steps {
                ...
                bat'mvn test'
                step([$class: 'XrayImportBuilder', endpointName: '', importFilePath: 'json:target/jihene.json', importInParallel: 'false', serverInstance: 'CLOUD-451b35e9-535d-4f52-bc37-28f4215cf1ea'])
