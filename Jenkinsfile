        ...
        stage('checkout') {
         ...
         stage('build') {
            steps {
                ...
                bat'mvn test'
                step([$class: 'XrayImportBuilder', endpointName: '/junit', importFilePath: 'target/surefire-reports/TEST-runcukes.RunCukesTest.xml', importInParallel: 'false', importToSameExecution: 'false', projectKey: 'PAR', serverInstance: 'CLOUD-451b35e9-535d-4f52-bc37-28f4215cf1ea', testPlanKey: 'PAR-11'])
